...
for index in "${!INFILE[@]}"; do
  python generate_samples.py "random/1-av/accel=0.5/with-lc/emissions/${INFILE[$index]}/emissions/emissions_1.csv" "random/1-av/accel=0.5/with-lc/${OUTFILE[$index]}.pkl"
done
